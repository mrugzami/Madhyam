            ...
            child: Column(
              children: <Widget>[
                ...
                ListTile(
                  ...
                  title: Text(fellowTraveller.phone.substring(0, 10)),
                ),
                ListTile(
    ...
    return Card(
      ...
      child: ListTile(
        leading: InkWell(
          onTap: () async {
            var userReviews =
                await widget.db.getUserReviewsFromPhone(fellowTraveller.uid);
            //todo show info AND uid/email
            userInfoAlertDIalog(
