...
class MainHomeScreen extends StatefulWidget {
  ...
  MainHomeScreen({@required this.db});
...
class _MainHomeScreenState extends State<MainHomeScreen> {
  ...
  String _googleAPiKey = "AIzaSyClJ7bohWjfhtUsd71UVKXfsu48-Wq5O5s";
  ...
  final Color darkBlueColor = Color(0xFF333333);
  ...
  RidesModel detailsRide = new RidesModel(
      fromText: 'from',
      toText: 'to',
      randPoints: [new LatLng(21.228125, 72.833771)],
      toLatLng: new LatLng(21.228125, 72.833771),
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SafeArea(child: homeScaffold()),
    );
  }
    ...
    return Align(
        ...
        child: Padding(
            ...
            child: SearchMapPlaceWidget(
              ...
              language: 'en',
              placeholder: str,
              icon: const IconData(58800, fontFamily: 'MaterialIcons'),
              iconColor: clr,
  ...
  _showRideDetails(RidesModel ridesModel) async {
    detailsReviewList =
        await widget.db.getUserReviewsFromPhone(ridesModel.driver.uid);
    setState(() {
      showResults = false;
      showDetails = true;
  ...
  _requestRideFinal() {
    ...
    var driverUserRide = UserRide(
        isDriver: true,
        uid: this.detailsRide.driver.uid,
        status: Status.pending,
        ride: this.detailsRide,
    ...
    return Container(
      ...
      child: GoogleMap(
        initialCameraPosition:
            CameraPosition(target: LatLng(23.022505, 72.571365), zoom: 15),
